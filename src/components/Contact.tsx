              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-transparent border-b border-border py-3 text-lg text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:border-foreground transition-colors duration-300"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-transparent border-b border-border py-3 text-lg text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:border-foreground transition-colors duration-300 resize-none"
                ...
                <button
                  type="submit"
                  className="border border-foreground text-foreground text-minimal px-10 py-4 hover:bg-foreground hover:text-background transition-all duration-500"
                >
                  Enviar
                </button>
              </form>
          ...
          <div className="flex flex-col justify-between">
            <div className="space-y-10">
              ...
              <div>
                ...
                <a
                  href="https://instagram.com/archstudio"
                  target="_blank"
