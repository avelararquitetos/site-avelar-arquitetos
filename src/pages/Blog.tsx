...
const Blog = () => {
  ...
  const categories = ["TODOS", "SUSTAINABILITY", "DESIGN", "URBAN PLANNING"];
          ...
          <div className="max-w-7xl mx-auto">
            <div className="mb-12">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl">
                ...
                através de análises cuidadosas e perspectivas contemporâneas.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-12">
              Inscreva-se na nossa newsletter para receber as últimas novidades sobre arquitetura e design
            </p>
